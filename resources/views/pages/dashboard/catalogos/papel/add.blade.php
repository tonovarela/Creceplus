                    ...
                    <div class="panel panel-default" style="padding: 20px;">
                        ...
                        <div class="panel-body">
                            <form name="maquina" class="form-horizontal" method="POST"
                                  action="{{URL('dashboard/catalogos/papel/store')}}" style="padding: 20px;">
                                <div class="form-group">
                                    <label for="Nombre">Nombre</label>
                                    <input type="hidden" name="id_tipopapel" value=""/>
                                    <input type="text" name="nombre" class="form-control" value="{{ Request::old('nombre') ?: '' }}"/>
                                </div>
                                <div class="form-group">
                                    <label for="Gramaje">Gramaje</label>
                                    <input type="text" name="gramaje" class="form-control" value="{{ Request::old('gramaje') ?: '' }}"/>
                                </div>
