...
@section('content')
    <div class="App" ng-controller="asignacionprocesoController" ng-cloak>
        <div class="wrapper">
            ...
            <section>
                ...
                <div class="content-wrapper" style="z-index:100">
                    <div class="content-heading">
                        <a href="{{URL::to("dashboard/catalogos/items")}}">
                            <em class="fa  fa-arrow-left"></em>
                        </a>Asignación de procesos
                    </div>
                </div>
                ...
                <div style="padding-left: 20px">
                    ...
                    <div class="row">
                        <div class="col-md-5">
                            ...
                            <div class="panel ">
                                <input type="hidden" ng-init="id_item={{$modelo->id_item}}"/>
                        ...
                        <div class="col-md-6 box-placeholder" >
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <button class="btn btn-purple btn-xs pull-right" ng-if="modificoItem==true"
                                    ...
                                    <div class="col-md-6">
                                        <a class="btn btn-default btn-xs pull-right"
                                                href="{{URL::to('dashboard/catalogos/items')}}"     ><em class="fa fa-close"></em></a>
                                    </div>
                                    <hr>
                                </div>
                            </div>
    ...
    <script src="{{ asset('logic/asignacionprocesos.js') }}"></script>
@endsection
